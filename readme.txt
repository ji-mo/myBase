...
11.rm ****    删除文件
12.git remote add origin git@github.com:ji-mo/codebase.git    链接
13.git push -u origin master    把本地仓库的内容推送到GitHub仓库
14.git clone git@github.com:ji-mo/codebase.git     远程同步本地
